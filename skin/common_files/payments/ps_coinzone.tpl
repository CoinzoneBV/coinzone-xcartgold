...
{capture name=dialog}
    <form action="cc_processing.php?cc_processor={$smarty.get.cc_processor|escape:"url"}" method="post">
        ...
        <table cellspacing="10">
            <tr>
                <td colspan="2">
                    Add your Client Code and API Key below to configure Coinzone. This can be found on the API tab of the Settings page in the <a href="https://merchant.coinzone.com/settings#apiTab">Coinzone control panel</a>.
                    <br/>
                    Have questions?  Please visit our <a href="http://support.coinzone.com/">Customer support site</a>.
                    <br/>
